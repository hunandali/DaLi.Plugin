...
#Region "词组处理"
	...
	Public Shared Property Segment_Keyword_Insert As String()

	''' <summary>移除的词组</summary>
	Public Shared Property Segment_Keyword_Remove As String()

	''' <summary>关键词分析停用词</summary>
	Public Shared Property Extractor_Stopwords As String()
	...
	Private Shared Function GetSentence(text As String) As IEnumerable(Of String)
		...
		If Sents.NotEmpty Then
			For I = 0 To Sents.Length - 1
				...
				If s.NotEmpty Then
					If s.Length > 1 AndAlso s.EndsWith("."c) Then
						Dim Flag = False
